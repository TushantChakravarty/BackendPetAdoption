            ...
            return dao.getUserDetails(query).then(async (userExists) => {
                ...
                if (userExists) {
                   ...
                   // details.loginActivity = loginActivity
                    ...
                    return dao.createUser(data).then((userCreated) => {
...
async function addPosts(input) {
    ...
    try{
       ...
       let updatePosts = dao.addPosts(query,updateDetails).then((userUpdated)=>{
            ...
            console.log(e)
            return  mapper.responseMapping(usrConst.CODE.BadRequest,'failed to upload posts')
 ...
 async function allPosts(input) {
                ...
                try{
                   ...
                   let updatePosts = dao.addToAllPosts(query,updateDetails).then((userUpdated)=>{
   ...
   async function getUserProfile(details){
    ...
    console.log(query)
    return dao.getUserProfile(query)
    .then((response)=>{
